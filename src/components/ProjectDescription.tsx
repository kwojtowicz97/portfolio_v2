      ...
      <div className='mt-7 flex flex-col sm:flex-row'>
        ...
        <div className='my-2 flex sm:my-0'>
          ...
          <a
            href={project.git}
            target='_blank'
            className='text-md flex aspect-square h-9 w-9 cursor-pointer content-center items-center justify-center rounded-full bg-black text-white transition-colors hover:bg-gray-800'
          >
