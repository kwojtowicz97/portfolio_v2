...
const AboutMeSection = () => {
  ...
  return (
    <section
      ...
      <div className='relative box-border flex flex-col overflow-hidden rounded-3xl border bg-gradient-to-br from-pink-300 via-purple-300 to-indigo-400 p-10 md:w-1/2'>
      ...
      <div className='rounded-3xl border bg-slate-100 object-cover p-5 md:max-h-fit md:w-1/2'>
